...
bool j1Player::Start()
{
	...
	collo.w = pl_w_h.x;
	collo.h = pl_w_h.y;
	player_collider = App->collisions->AddCollider(collo, COLLIDER_PLAYER, this);
	//Collider ----------------------------
...
void j1Player::OnCollision(Collider *player, Collider *colli)
{
...
bool j1Player::LoadAnimation(pugi::xml_node & config, Animation& anim)
{
...
bool j1Player::LoadAllAnimations(pugi::xml_node & anima)
{
...
void j1Player::ChangetoCurrentAnimation()
{
